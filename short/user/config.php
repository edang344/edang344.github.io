...
define( 'YOURLS_DB_USER', 'id896288_ls' );

/** MySQL database password */
define( 'YOURLS_DB_PASS', 'Password1' );

/** The name of the database for YOURLS */
define( 'YOURLS_DB_NAME', 'id896288_ls' );
...
define( 'YOURLS_SITE', 'http://eric-dang.com/short' );
...
define( 'YOURLS_COOKIEKEY', 'vgMT@8]x5%UJInVjbO_dVImg6A6)|U#E-PgY5s5t' );
